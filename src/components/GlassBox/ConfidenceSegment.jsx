import { getConfidenceStyle, getCategoryIcon } from '../../utils/confidence'

export default function ConfidenceSegment({
  segment,
  isHovered,
  onHover,
  onLeave,
  ...
  const colors = getConfidenceStyle(segment.confidence)
    ...
    >
      ...
      {isHovered && showTransparency && (
        ...
        >
          ...
          >
            Parameter Influence on This Segment
          </div>
