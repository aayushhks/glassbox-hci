...
const LIKERT_QUESTIONS = [
    { id: 'trust', text: 'I trusted the AI\'s output enough to use it without major edits.' },
    { id: 'control', text: 'I felt in control of how the AI generated its response.' },
    { id: 'understanding', text: 'I understood why the AI produced the output it did.' },
    { id: 'satisfaction', text: 'I am satisfied with the quality of the final output.' },
    ...
    { id: 'agency', text: 'I felt like a collaborator with the AI, not just a user.' },
    { id: 'transparency', text: 'The interface helped me identify which parts of the output to scrutinize.' },
]
