...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        Does exposing an AI's internal generation parameters through visual controls improve user
        trust and steerability? Explore both conditions below.
      </p>
      ...
      <div style={{ display: 'flex', gap: 20, maxWidth: 700, width: '100%' }}>
        ...
        >
          ...
          <p style={{ fontSize: 13, color: '#7a8a9a', lineHeight: 1.6, marginBottom: 16 }}>
            ...
            language prompts — the typical chatbot experience.
          </p>
        ...
        >
          ...
          <p style={{ fontSize: 13, color: '#7a9a8a', lineHeight: 1.6, marginBottom: 16 }}>
            Transparent interface with confidence highlights and parameter sliders. Users
            directly manipulate AI generation behavior through visual controls.
          </p>
